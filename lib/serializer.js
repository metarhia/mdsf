...
// being included along with the sandboxed code.
// We don't just put it inside a context because it
// would be bound to the global context and would
// expose it to the sandboxed code during the execution
// of typeof if it defines a maliciouos getter.
//
...
serializer.parse = function parse(str) {
  var source = '"use strict";' + $validateRecord.toString() +
    '$validateRecord(' + str + ')';
