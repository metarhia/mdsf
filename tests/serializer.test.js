...
var jstp = require('..');
var browserJstp = require('../browser');

function runAllTests(jstp, title) {
  ...
  describe(title + ' Serializer and Deserializer', function() {
    describe(title + ' Record Serialization', function() {
...
runAllTests(jstp, 'JSTP');
runAllTests(browserJstp, 'Browser JSTP');
